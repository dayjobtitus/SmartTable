...
<!DOCTYPE html><html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            /*
             *  This example shows pretty much basic and most common expected usage
             *  - A simple array of objects that have fields with data that we want to display in table form
             *  - A simple build object with some standard attributes and a header and body map controlling the display of data
             */
            (function() {
