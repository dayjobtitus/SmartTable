...
<!DOCTYPE html><html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            /*
            * This example is the same as complex data but shows the ability to use url parameters to allow direct hyperlinking to specific filtered and sorted data
            */
            (function() {
